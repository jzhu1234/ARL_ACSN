...
# Read in text file
df <- read.table('~/Documents/python_code/log_CKN.txt')
...
```{r}
lifetime <- read.table('~/Documents/python_code/lifetime_CKN.txt')
...
event_detect <- read.table('~/Documents/python_code/detect_CKN.txt')
